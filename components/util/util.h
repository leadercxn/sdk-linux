...
/**
 * [util_singleton_process description]
 *
...
/**
 * [util_singleton_close description]
 *
 * @return        [description]
 */
...
/**
 * [util_strsplit description]
 *
 * @param    str          [description]
 * @param    separator    [description]
 * @param    pp_array     [description]
 * @param    p_num        [description]
